...
\name{Michael D. Pratt \vspace*{.1in}}

\begin{resume}
\section{\sc Contact Information}
\vspace{.05in}
\begin{tabular}{@{}p{2in}p{4in}}
2106 Woodbury Drive             & {\it Voice:}  (919) 271-4250 \\            
Hillsborough, NC 27278          & {\it E-mail:}  michael@pratt.im\\
\end{tabular}
...
\vspace*{-.1in}
\begin{list1}
\item[] B.S., Computer and Electrical Engineering,  GPA: 3.96/4.00, Expected May, 2015
\end{list1}

{\bf Cedar Ridge High School}, Hillsborough, North Carolina USA\\
\vspace*{-.1in}
\begin{list2}
\item High School Diploma, GPA: 3.99/4.00,  June, 2011
\end{list2}


\section{\sc Honors and Awards} 
Goodnight Scholarship, North Carolina State University, 2011

\vspace*{-2.5mm}
People Helping People Scholarship, NC State Employees' Credit Union, 2011

\vspace*{-2.5mm}
Eagle Scout Award, Boy Scouts of America, 2010
\begin{list2}
\item Designed and carried out plan to improve an elementary school's nature trail
\end{list2}
